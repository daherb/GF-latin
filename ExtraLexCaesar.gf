concrete ExtraLexCaesar of ExtraLexCaesarAbs = CatLat ** open Prelude,ParadigmsLat,ResLat, IrregLat, LexiconLat,StructuralLat in {
  lin
    ...
    abducere_V = prefixVerb "ab" ducere_V; -- ab + ducere, missing abduci (inf VInfPassPres : abduceri)
    abesse_V = prefixVerb "ab" be_V; -- missing absente?
    abicere_V = prefixVerb "ab" iacere_V; -- ab + iacere
    ...
    abstinere_V2 = prefixVerb2 "ab" tenere_V2 ; --mkV "abstinere" ; -- ab + tenere
    abstrahere_V2 = prefixVerb2 "ab" trahere_V2 ; -- ab + trahere
    ac_Conj = mkConj "ac" "" Sg ;
    accedere_V = prefixVerb "ad" cedere_V ; -- ad + cedere
    accendere_V = mkV "accendere" "accendo" "accendi" "accensum"; 
    accidere_V = mkV "accidere" "accido" "accidi" "accisum"; -- ad + caedere?
    accipere_V = prefixVerb "ad" capere_V; -- ad + capere
    ...
    accurrere_V = prefixVerb "ad" currere_V; -- ad + currere
    ...
    adamare_V2 = prefixVerb2 "ad" love_V2; -- ad + amare, missing adamassent (act (VAct VAnt (VImpf VConj) Pl P3) : adamavissent)?
    adducere_V = prefixVerb "ad" ducere_V; -- ad + ducere, missing adduci
    adequitare_V = prefixVerb "ad" equitare_V; -- ad + equitare
    ...
    adire_V = prefixVerb "ad" ire_V; -- ad + ire, missing adiisset, aditus?
    ...
    advenire_V = prefixVerb "ad" venire_V; -- ad + venire, mkV "advenire" "advenio" "adveni" "adventum";
...
--    aliquis_Pron = aliquis;
    ...
    anteponere_V = prefixVerb2 "ante" put_V2; -- ante + ponere
    ...
    circumdare_V = prefixVerb "circum" dare_V; --mkV "circumdare" "circumdo" "circumdedi" "circumdatum"; -- missing circumdederant, circumdederunt
    circumducere_V = prefixVerb "circum" ducere_V;
    circumiectus_A = mkA "circumiectus";
    circumire_V = prefixVerb "circum" ire_V;
    circummunire_V = mkV "circummunire";
    circumsistere_1_V = prefixVerb "circum" sistere_1_V;
    circumsistere_2_V = prefixVerb "circum" sistere_2_V;
    circumvenire_V = prefixVerb "circum" venire_V;
    ...
    cooriri_V = prefixVerb "co" oriri_V; -- con + oriri, missing coorta
    conferre_V = prefixVerb "con" ferre_V; -- con + ferre
  ---
    conspicere_V = prefixVerb "con" specere_V;
    conspirare_V = mkV "conspirare"; -- con + spirare?
    constanter_Adv = ss "constanter"; -- comparison
    constantia_N = mkN "constantia";
    constare_V = prefixVerb "con" stare_V; -- con + stare, missing constiterant, constiterat, constiterunt, constitissent, constitisset, constitit
    consternare_V = mkV "consternare";
    consternere_V = mkV "consternere" "consterno" "constravi" "constratum"; -- con + sternere?
    constituere_V = prefixVerb "con" statuere_V;
    ...
    contexere_V = prefixVerb "con" texere_V; -- con + texere
    continens_N = mkN "continens" "continentis" feminine;
    continenter_Adv = ss "continenter";
    continere_V2 = prefixVerb2 "con" tenere_V2;
    ...
    contrahere_V2 = prefixVerb2 "con" trahere_V2;
